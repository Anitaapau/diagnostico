##Crear una clase llamada vehículo  capaz de procesar la información básica de los autos en una consencionaria. Deberá tener constructor y los atributos del vehículo serán: patente, marca, modelo y kilometraje. Crear métodos (de acceso) getter y (de modificación) setter mostrará por pantalla al menos 1 atributo y modificar el kilometraje
class Vehículo:
